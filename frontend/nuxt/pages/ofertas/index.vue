    ...
    <main class="page-content">
      ...
      <div v-else-if="ofertasFiltradas.length > 0" class="ofertas-grid animate-fade-in-up stagger-2">
        ...
        >
          ...
          <!-- Imagen -->
          <div class="oferta-img" @click="navigateTo(`/productos?q=${encodeURIComponent(oferta.producto?.nombre_prod || '')}`)">
          ...
          <div class="oferta-actions">
            <button class="ver-btn" @click="navigateTo(`/productos?q=${encodeURIComponent(oferta.producto?.nombre_prod || '')}`)">
              Ver producto
            </button>
          </div>
        </div>
